...
{ //All CRUD calls
    public class CustomerManager //Called to get information from the database
    {
        private readonly ICustomerService _service; //Interface

        public CustomerManager(ICustomerService service) //Injecting interface into constructor - dependency of Customer Manager Away from Database
        {
            if (service == null)
            {
