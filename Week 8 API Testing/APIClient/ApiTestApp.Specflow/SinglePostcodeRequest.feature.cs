...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "", "SinglePostcodeRequest", "In order to get the details of a postcode\r\nAs a user \r\nI want to be able to make " +
                    "a request for a single postcode on postcodes.io", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 8
testRunner.Given("I have initialized the SinglePostcodeService", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
        }
...
#line hidden
#line 13
 testRunner.Then("Status in the JSON response body should be 200", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 14
...
#line hidden
#line 19
 testRunner.Then("The JSON Response body should match the JSON Schema in \"SucessfulSinglePostcodeRe" +
                        "sponse.json\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
